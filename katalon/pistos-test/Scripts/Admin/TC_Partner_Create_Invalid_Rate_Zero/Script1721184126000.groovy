...
WebUI.setText(findTestObject('Page_AdminPartners/input_createName'), 'Invalid Rate Partner')
WebUI.setText(findTestObject('Page_AdminPartners/input_createCode'), 'INVR')
WebUI.setText(findTestObject('Page_AdminPartners/input_createPointsRate'), '0')
...
WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Partner_Create_Invalid_Rate_Zero' + '.png')
