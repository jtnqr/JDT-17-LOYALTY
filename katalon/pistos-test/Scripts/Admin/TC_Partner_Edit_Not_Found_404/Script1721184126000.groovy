...
WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/admin/partners/non-existent-partner-id-99999')
WebUI.waitForElementVisible(findTestObject('Page_AdminPartners/lbl_noPartnerFound'), 10)

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Partner_Edit_Not_Found_404' + '.png')
