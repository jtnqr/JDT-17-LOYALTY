...
WebUI.waitForElementVisible(findTestObject('Page_AdminPartners/btn_viewAllPartners'), 10)

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Partner_View_List_All' + '.png')
