...
// Create a temp invalid format logo file (.tiff)
File tempFile = File.createTempFile("test_partner_logo_invalid", ".tiff")
tempFile.text = "INVALID_LOGO_TIFF_CONTENT"
...
WebUI.delay(2)
WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Partner_Upload_Logo_Invalid_Format' + '.png')
