...
WebUI.waitForElementVisible(findTestObject('Page_AdminRewards/input_pointsCost'), 5)
WebUI.setText(findTestObject('Page_AdminRewards/input_pointsCost'), '300')
WebUI.click(findTestObject('Page_AdminRewards/btn_saveRewardChanges'))

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Reward_Edit_Update_Cost' + '.png')
