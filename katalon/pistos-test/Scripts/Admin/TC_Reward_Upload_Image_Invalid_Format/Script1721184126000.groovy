...
// Create a temp invalid format image file (.tiff)
File tempFile = File.createTempFile("test_reward_invalid", ".tiff")
tempFile.text = "INVALID_IMAGE_TIFF_CONTENT"
...
WebUI.delay(2)
WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Reward_Upload_Image_Invalid_Format' + '.png')
