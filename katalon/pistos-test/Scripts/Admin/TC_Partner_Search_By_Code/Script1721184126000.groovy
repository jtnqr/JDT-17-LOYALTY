...
WebUI.setText(findTestObject('Page_AdminPartners/input_searchPartner'), 'KFC')

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Partner_Search_By_Code' + '.png')
