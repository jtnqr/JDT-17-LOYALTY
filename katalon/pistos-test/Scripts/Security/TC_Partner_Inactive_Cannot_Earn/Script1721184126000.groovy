...
String pName = "KFC Inactive Test " + timestamp
String pCode = "KFCI" + timestamp.substring(timestamp.length()-4)
...
WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshots/' + 'TC_Partner_Inactive_Cannot_Earn' + '.png')
